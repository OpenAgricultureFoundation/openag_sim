...
#However, GreenScilab requires sum of cumulated thermal time, so use the above for reference
...
def reader(args):
    ...
    for elt in os.listdir(input_directory):
        ...
        with open(input_directory+"/"+elt,"rb") as csvfile:
            ...
            outputParameter(newRainAvg,temperatureAvg,radiationAvg,input_directory,fileName)
