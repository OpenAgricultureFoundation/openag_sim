...
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_31_ok
button $dw.buttons.cancel -text "Cancel" -command detail_31_cancel
button $dw.buttons.display -text "Display" -command detail_31_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de31en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de31en11 [lindex $inter_Nu_B3 0]
	set de31en12 [lindex $inter_Ang_B3 0]
	set de31en13 [lindex $inter_VB 2]
	set de31en21 [lindex $inter_Nu_Ff3 0]
	set de31en22 [lindex $inter_Ang_Ff3 0]
	set de31en23 [lindex $inter_VF 2]
	set de31en31 [lindex $inter_Nu_Fm3 0]
	set de31en32 [lindex $inter_Ang_Fm3 0]
	set de31en41 [lindex $inter_Nu_A3 0]
	set de31en42 [lindex $inter_Ang_A3 0]
	set de31en43 [lindex $inter_VI 2]
