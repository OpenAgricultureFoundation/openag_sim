...
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_14_ok
button $dw.buttons.cancel -text "Cancel" -command detail_14_cancel
button $dw.buttons.display -text "Display" -command detail_14_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de14en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de14en11 [lindex $inter_Nu_B1 3]
	set de14en12 [lindex $inter_Ang_B1 3]
	set de14en21 [lindex $inter_Nu_Ff1 3]
	set de14en22 [lindex $inter_Ang_Ff1 3]
	set de14en31 [lindex $inter_Nu_Fm1 3]
	set de14en32 [lindex $inter_Ang_Fm1 3]
	set de14en41 [lindex $inter_Nu_A1 3]
	set de14en42 [lindex $inter_Ang_A1 3]
	set de14en43 [lindex $inter_VI 0]
	set de14en13 [lindex $inter_VB 0]
	set de14en23 [lindex $inter_VF 0]
...
proc detail_14_ok {} {
	...
	set test1 [lrange $inter_Nu_B1 0 2]
	set test2 [lrange $inter_Nu_B1 4 5]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en11 get]]
	set inter_Nu_B1 [lrange $test 0 5]
	set test1 [lrange $inter_Nu_Ff1 0 2]
	set test2 [lrange $inter_Nu_Ff1 4 5]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en21 get]]
	set inter_Nu_Ff1 [lrange $test 0 5]
	set test1 [lrange $inter_Nu_Fm1 0 2]
	set test2 [lrange $inter_Nu_Fm1 4 5]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en31 get]]
	set inter_Nu_Fm1 [lrange $test 0 5]
	set test1 [lrange $inter_Nu_A1 0 2]
	set test2 [lrange $inter_Nu_A1 4 5]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en41 get]]
	set inter_Nu_A1 [lrange $test 0 5]
	set test1 [lrange $inter_Ang_B1 0 2]
	set test2 [lrange $inter_Ang_B1 4 5]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en12 get]]
	set inter_Ang_B1 [lrange $test 0 5]
	set test1 [lrange $inter_Ang_Ff1 0 2]
	set test2 [lrange $inter_Ang_Ff1 4 5]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en22 get]]
	set inter_Ang_Ff1 [lrange $test 0 5]
	set test1 [lrange $inter_Ang_Fm1 0 2]
	set test2 [lrange $inter_Ang_Fm1 4 5]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en32 get]]
	set inter_Ang_Fm1 [lrange $test 0 5]
	set test1 [lrange $inter_Ang_A1 0 2]
	set test2 [lrange $inter_Ang_A1 4 5]
	set test [concat $test1 $test2]
