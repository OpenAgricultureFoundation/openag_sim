...
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_21_ok
button $dw.buttons.cancel -text "Cancel" -command detail_21_cancel
button $dw.buttons.display -text "Display" -command detail_21_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de21en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de21en11 [lindex $inter_Nu_B2 0]
	set de21en12 [lindex $inter_Ang_B2 0]
	set de21en13 [lindex $inter_VB 1]
	set de21en21 [lindex $inter_Nu_Ff2 0]
	set de21en22 [lindex $inter_Ang_Ff2 0]
	set de21en23 [lindex $inter_VF 1]
	set de21en31 [lindex $inter_Nu_Fm2 0]
	set de21en32 [lindex $inter_Ang_Fm2 0]
	set de21en41 [lindex $inter_Nu_A2 0]
	set de21en42 [lindex $inter_Ang_A2 0]
	set de21en43 [lindex $inter_VI 1]
