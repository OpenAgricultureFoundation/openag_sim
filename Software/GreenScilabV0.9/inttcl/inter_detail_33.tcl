...
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_33_ok
button $dw.buttons.cancel -text "Cancel" -command detail_33_cancel
button $dw.buttons.display -text "Display" -command detail_33_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de33en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de33en11 [lindex $inter_Nu_B3 2]
	set de33en12 [lindex $inter_Ang_B3 2]
	set de33en21 [lindex $inter_Nu_Ff3 2]
	set de33en22 [lindex $inter_Ang_Ff3 2]
	set de33en31 [lindex $inter_Nu_Fm3 2]
	set de33en32 [lindex $inter_Ang_Fm3 2]
	set de33en41 [lindex $inter_Nu_A3 2]
	set de33en42 [lindex $inter_Ang_A3 2]
	set de33en43 [lindex $inter_VI 2]
	set de33en13 [lindex $inter_VB 2]
	set de33en23 [lindex $inter_VF 2]
...
proc detail_33_ok {} {
	...
	set test1 [lrange $inter_Nu_B3 0 1]
	set test2 [lrange $inter_Nu_B3 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en11 get]]
	set inter_Nu_B3 [lrange $test 0 4]
	set test1 [lrange $inter_Nu_Ff3 0 1]
	set test2 [lrange $inter_Nu_Ff3 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en21 get]]
	set inter_Nu_Ff3 [lrange $test 0 4]
	set test1 [lrange $inter_Nu_Fm3 0 1]
	set test2 [lrange $inter_Nu_Fm3 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en31 get]]
	set inter_Nu_Fm3 [lrange $test 0 4]
	set test1 [lrange $inter_Nu_A3 0 1]
	set test2 [lrange $inter_Nu_A3 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en41 get]]
	set inter_Nu_A3 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_B3 0 1]
	set test2 [lrange $inter_Ang_B3 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en12 get]]
	set inter_Ang_B3 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_Ff3 0 1]
	set test2 [lrange $inter_Ang_Ff3 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en22 get]]
	set inter_Ang_Ff3 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_Fm3 0 1]
	set test2 [lrange $inter_Ang_Fm3 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en32 get]]
	set inter_Ang_Fm3 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_A3 0 1]
	set test2 [lrange $inter_Ang_A3 3 4]
	set test [concat $test1 $test2]
