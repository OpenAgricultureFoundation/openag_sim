...
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_23_ok
button $dw.buttons.cancel -text "Cancel" -command detail_23_cancel
button $dw.buttons.display -text "Display" -command detail_23_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de23en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de23en11 [lindex $inter_Nu_B2 2]
	set de23en12 [lindex $inter_Ang_B2 2]
	set de23en21 [lindex $inter_Nu_Ff2 2]
	set de23en22 [lindex $inter_Ang_Ff2 2]
	set de23en31 [lindex $inter_Nu_Fm2 2]
	set de23en32 [lindex $inter_Ang_Fm2 2]
	set de23en41 [lindex $inter_Nu_A2 2]
	set de23en42 [lindex $inter_Ang_A2 2]
	set de23en43 [lindex $inter_VI 1]
	set de23en13 [lindex $inter_VB 1]
	set de23en23 [lindex $inter_VF 1]
...
proc detail_23_ok {} {
	...
	set test1 [lrange $inter_Nu_B2 0 1]
	set test2 [lrange $inter_Nu_B2 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en11 get]]
	set inter_Nu_B2 [lrange $test 0 4]
	set test1 [lrange $inter_Nu_Ff2 0 1]
	set test2 [lrange $inter_Nu_Ff2 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en21 get]]
	set inter_Nu_Ff2 [lrange $test 0 4]
	set test1 [lrange $inter_Nu_Fm2 0 1]
	set test2 [lrange $inter_Nu_Fm2 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en31 get]]
	set inter_Nu_Fm2 [lrange $test 0 4]
	set test1 [lrange $inter_Nu_A2 0 1]
	set test2 [lrange $inter_Nu_A2 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en41 get]]
	set inter_Nu_A2 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_B2 0 1]
	set test2 [lrange $inter_Ang_B2 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en12 get]]
	set inter_Ang_B2 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_Ff2 0 1]
	set test2 [lrange $inter_Ang_Ff2 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en22 get]]
	set inter_Ang_Ff2 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_Fm2 0 1]
	set test2 [lrange $inter_Ang_Fm2 3 4]
	set test [concat $test1 $test2]
	set test [linsert $test 2 [$dw.f.en32 get]]
	set inter_Ang_Fm2 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_A2 0 1]
	set test2 [lrange $inter_Ang_A2 3 4]
	set test [concat $test1 $test2]
