...
########################## c is a array ;  cc is a list  ###############
   ...
   "Flag_demand_biomass_layer" {
    ...
    "Time_Expansion(c_t_exp)" {
                  set inter_c_t_exp [lrange $cc 1 7]
                   }    
    "Para_a(c_Bt_a)" {
                  set inter_c_Bt_a [lrange $cc 1 7]
                   }                          
    "Para_b(c_Bt_b)" {
                  set inter_c_Bt_b [lrange $cc 1 7]
                   }                       
    "Sink_Blade(c_S_B)" {
                  set inter_c_S_B [lrange $cc 1 6]
                   }                       
    "Sink_Petiole(c_S_P)" {
                  set inter_c_S_P [lrange $cc 1 6]
                   }          
    "Sink_Internode(c_S_I)" {
                  set inter_c_S_I [lrange $cc 1 6]
                   }                             
    "Sink_Female(c_S_Ff)" {
                  set inter_c_S_Ff [lrange $cc 1 6]
                   }                             
    "Sink_Male(c_S_Fm)" {
                  set inter_c_S_Fm [lrange $cc 1 6]
                   }                             
    "Sink_Layer(c_S_L)" {
                  set inter_c_S_L [lrange $cc 1 6]
                   }                         
    "Sink_Root(c_S_R)" {
                  set inter_c_S_R [lrange $cc 1 6]
                   }                         
    "Allom_Internode(c_a_bI)" {
                  set inter_c_a_bI [lrange $cc 1 6]
                  }
    "(c_a_aI)" {
                  set inter_c_a_aI [lrange $cc 1 6]
                   }                              
    "Allom_Petiole(c_a_bP)" {
                  set inter_c_a_bP [lrange $cc 1 6]
                   }                               
    "(c_a_aP)" {
                  set inter_c_a_aP [lrange $cc 1 6]
                   }                               
    "Allom_Thick(c_Th_B)" {
                  set inter_c_Th_B [lrange $cc 1 6]
                   }  
    "Female_Density(c_Den_Ff)" {
                  set inter_c_Den_Ff [lrange $cc 1 6]
                   }                     
    "Male_Density(c_Den_Fm)" {
                  set inter_c_Den_Fm [lrange $cc 1 6]
                   }                     
    "Internode_Dens(c_Den_I)" {
                  set inter_c_Den_I [lrange $cc 1 6]
                   } 
    "Resist_Blade(c_r_B)" {
                  set inter_c_r_B $c(2)
                   }                        
    "Resist_Petiole(c_r_P)" {
                  set inter_c_r_P $c(2)
                   }                        
    "Resist_Root(c_r_R)" {
                  set inter_c_r_R $c(2)
