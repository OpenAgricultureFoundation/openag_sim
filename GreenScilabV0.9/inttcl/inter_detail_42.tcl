...
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_42_ok
button $dw.buttons.cancel -text "Cancel" -command detail_42_cancel
button $dw.buttons.display -text "Display" -command detail_42_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de42en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de42en11 [lindex $inter_Nu_B4 1]
	set de42en12 [lindex $inter_Ang_B4 1]
	set de42en21 [lindex $inter_Nu_Ff4 1]
	set de42en22 [lindex $inter_Ang_Ff4 1]
	set de42en31 [lindex $inter_Nu_Fm4 1]
	set de42en32 [lindex $inter_Ang_Fm4 1]
	set de42en41 [lindex $inter_Nu_A4 1]
	set de42en42 [lindex $inter_Ang_A4 1]
	set de42en43 [lindex $inter_VI 3]
	set de42en13 [lindex $inter_VB 3]
	set de42en23 [lindex $inter_VF 3]
...
proc detail_42_ok {} {
	...
	set test1 [lindex $inter_Nu_B4 0]
	set test2 [lrange $inter_Nu_B4 2 3]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en11 get]]
	set inter_Nu_B4 [lrange $test 0 4]
	set test1 [lindex $inter_Nu_Ff4 0]
	set test2 [lrange $inter_Nu_Ff4 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en21 get]]
	set inter_Nu_Ff4 [lrange $test 0 4]
	set test1 [lindex $inter_Nu_Fm4 0]
	set test2 [lrange $inter_Nu_Fm4 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en31 get]]
	set inter_Nu_Fm4 [lrange $test 0 4]
	set test1 [lindex $inter_Nu_A4 0]
	set test2 [lrange $inter_Nu_A4 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en41 get]]
	set inter_Nu_A4 [lrange $test 0 4]
	set test1 [lindex $inter_Ang_B4 0]
	set test2 [lrange $inter_Ang_B4 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en12 get]]
	set inter_Ang_B4 [lrange $test 0 4]
	set test1 [lindex $inter_Ang_Ff4 0]
	set test2 [lrange $inter_Ang_Ff4 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en22 get]]
	set inter_Ang_Ff4 [lrange $test 0 4]
	set test1 [lindex $inter_Ang_Fm4 0]
	set test2 [lrange $inter_Ang_Fm4 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en32 get]]
	set inter_Ang_Fm4 [lrange $test 0 4]
	set test1 [lindex $inter_Ang_A4 0]
	set test2 [lrange $inter_Ang_A4 2 4]
	set test [concat $test1 $test2]
