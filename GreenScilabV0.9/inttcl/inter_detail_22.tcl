...
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_22_ok
button $dw.buttons.cancel -text "Cancel" -command detail_22_cancel
button $dw.buttons.display -text "Display" -command detail_22_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de22en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de22en11 [lindex $inter_Nu_B2 1]
	set de22en12 [lindex $inter_Ang_B2 1]
	set de22en21 [lindex $inter_Nu_Ff2 1]
	set de22en22 [lindex $inter_Ang_Ff2 1]
	set de22en31 [lindex $inter_Nu_Fm2 1]
	set de22en32 [lindex $inter_Ang_Fm2 1]
	set de22en41 [lindex $inter_Nu_A2 1]
	set de22en42 [lindex $inter_Ang_A2 1]
	set de22en43 [lindex $inter_VI 1]
	set de22en13 [lindex $inter_VB 1]
	set de22en23 [lindex $inter_VF 1]
...
proc detail_22_ok {} {
	...
	set test1 [lindex $inter_Nu_B2 0]
	set test2 [lrange $inter_Nu_B2 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en11 get]]
	set inter_Nu_B2 [lrange $test 0 4]
	set test1 [lindex $inter_Nu_Ff2 0]
	set test2 [lrange $inter_Nu_Ff2 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en21 get]]
	set inter_Nu_Ff2 [lrange $test 0 4]
	set test1 [lindex $inter_Nu_Fm2 0]
	set test2 [lrange $inter_Nu_Fm2 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en31 get]]
	set inter_Nu_Fm2 [lrange $test 0 4]
	set test1 [lindex $inter_Nu_A2 0]
	set test2 [lrange $inter_Nu_A2 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en41 get]]
	set inter_Nu_A2 [lrange $test 0 4]
	set test1 [lindex $inter_Ang_B2 0]
	set test2 [lrange $inter_Ang_B2 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en12 get]]
	set inter_Ang_B2 [lrange $test 0 4]
	set test1 [lindex $inter_Ang_Ff2 0]
	set test2 [lrange $inter_Ang_Ff2 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en22 get]]
	set inter_Ang_Ff2 [lrange $test 0 4]
	set test1 [lindex $inter_Ang_Fm2 0]
	set test2 [lrange $inter_Ang_Fm2 2 4]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en32 get]]
	set inter_Ang_Fm2 [lrange $test 0 4]
	set test1 [lindex $inter_Ang_A2 0]
	set test2 [lrange $inter_Ang_A2 2 4]
	set test [concat $test1 $test2]
