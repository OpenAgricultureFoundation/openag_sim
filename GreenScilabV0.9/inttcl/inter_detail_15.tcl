...
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_15_ok
button $dw.buttons.cancel -text "Cancel" -command detail_15_cancel
button $dw.buttons.display -text "Display" -command detail_15_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de15en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de15en11 [lindex $inter_Nu_B1 4]
	set de15en12 [lindex $inter_Ang_B1 4]
	set de15en21 [lindex $inter_Nu_Ff1 4]
	set de15en22 [lindex $inter_Ang_Ff1 4]
	set de15en31 [lindex $inter_Nu_Fm1 4]
	set de15en32 [lindex $inter_Ang_Fm1 4]
	set de15en41 [lindex $inter_Nu_A1 4]
	set de15en42 [lindex $inter_Ang_A1 4]
	set de15en43 [lindex $inter_VI 0]
	set de15en13 [lindex $inter_VB 0]
	set de15en23 [lindex $inter_VF 0]
...
proc detail_15_ok {} {
	...
	set test1 [lrange $inter_Nu_B1 0 3]
	set test2 [lrange $inter_Nu_B1 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 [$dw.f.en11 get]]
	set inter_Nu_B1 [lrange $test 0 5]
	set test1 [lrange $inter_Nu_Ff1 0 3]
	set test2 [lrange $inter_Nu_Ff1 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 [$dw.f.en21 get]]
	set inter_Nu_Ff1 [lrange $test 0 5]
	set test1 [lrange $inter_Nu_Fm1 0 3]
	set test2 [lrange $inter_Nu_Fm1 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 [$dw.f.en31 get]]
	set inter_Nu_Fm1 [lrange $test 0 5]
	set test1 [lrange $inter_Nu_A1 0 3]
	set test2 [lrange $inter_Nu_A1 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 [$dw.f.en41 get]]
	set inter_Nu_A1 [lrange $test 0 5]
	set test1 [lrange $inter_Ang_B1 0 3]
	set test2 [lrange $inter_Ang_B1 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 [$dw.f.en12 get]]
	set inter_Ang_B1 [lrange $test 0 5]
	set test1 [lrange $inter_Ang_Ff1 0 3]
	set test2 [lrange $inter_Ang_Ff1 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 [$dw.f.en22 get]]
	set inter_Ang_Ff1 [lrange $test 0 5]
	set test1 [lrange $inter_Ang_Fm1 0 3]
	set test2 [lrange $inter_Ang_Fm1 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 [$dw.f.en32 get]]
	set inter_Ang_Fm1 [lrange $test 0 5]
	set test1 [lrange $inter_Ang_A1 0 3]
	set test2 [lrange $inter_Ang_A1 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 [$dw.f.en42 get]]
