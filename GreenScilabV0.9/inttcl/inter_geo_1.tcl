...
toplevel $w
wm title $w "PA 1 -- Geometrical Parameter Setting"
wm iconname $w "Greenlab"
wm geometry $w 450x280+230+150

######### create "ok" and "cancel" buttons
frame $w.buttons 
button $w.buttons.ok -text "Ok" -command geo_1_ok
button $w.buttons.cancel -text "Cancel" -command geo_1_cancel
...
for {set i 1} {$i<=8} {incr i} {
   entry $w.left.bot.en$i -textvariable geo1leften$i -width 6
...
for {set i 1} {$i <=5}  {incr i} {
   entry $w.right.bot.en$i -textvariable geo1righten$i -width 4
   grid $w.right.bot.lb$i $w.right.bot.en$i
}
for {set i 6} {$i<=9} {incr i} {
   checkbutton $w.right.bot.en$i -variable geo1righten$i 
   grid $w.right.bot.lb$i $w.right.bot.en$i
} 
...
proc init_widget { } {
	...
	for {set i 1} {$i<=9} {incr i} {
	    global geo1righten$i
	    }
	set geo1leften1 [lindex $inter_Ang_Ph 0]
	set geo1leften2 [lindex $inter_Ey 0] 
	set geo1leften3 [lindex $inter_fp 0]
	set geo1leften4 [lindex $inter_Eng_Ang 0]
	set geo1leften5 [lindex $inter_Eng_N 0]
	set geo1leften6 [lindex $inter_InitMin 0]
	set geo1leften7 [lindex $inter_InitMax 0]
	set geo1leften8 [lindex $inter_InitNum 0]
	set geo1righten1 [lindex $inter_wb 0]
	set geo1righten2 [lindex $inter_wbn 0]
	set geo1righten3 [lindex $inter_Theta_L 0]
	set geo1righten4 [lindex $inter_Theta_F 0]
	set geo1righten5 [lindex $inter_Theta_B 0]
	set geo1righten6 [lindex $inter_Flag_Organ_bending 0]
	set geo1righten7 [lindex $inter_Flag_Bending_by_node 0]
	set geo1righten8 [lindex $inter_Flag_Plagiotropic  0]
	set geo1righten9 [lindex $inter_Flag 0]
}
...
proc geo_1_ok { } {
	...
	set test [lrange $inter_Ang_Ph 1 5]
	set test [linsert $test 0 [$w.left.bot.en1 get]]
	set inter_Ang_Ph [lrange $test 0 5]
	set test [lrange $inter_Ey 1 5]
	set test [linsert $test 0 [$w.left.bot.en2 get]]
	set inter_Ey [lrange $test 0 5]
	set test [lrange $inter_fp 1 5]
	set test [linsert $test 0 [$w.left.bot.en3 get]]
	set inter_fp [lrange $test 0 5]
	set test [lrange $inter_Eng_Ang 1 5]
	set test [linsert $test 0 [$w.left.bot.en4 get]]
	set inter_Eng_Ang [lrange $test 0 5]
	set test [lrange $inter_Eng_N 1 5]
	set test [linsert $test 0 [$w.left.bot.en5 get]]
	set inter_Eng_N [lrange $test 0 5]
	set test [lrange $inter_InitMin 1 5]
	set test [linsert $test 0 [$w.left.bot.en6 get]]
	set inter_InitMin [lrange $test 0 5]
	set test [lrange $inter_InitMax 1 5]
	set test [linsert $test 0 [$w.left.bot.en7 get]]
	set inter_InitMax [lrange $test 0 5]
	set test [lrange $inter_InitNum 1 5]
	set test [linsert $test 0 [$w.left.bot.en8 get]]
	set inter_InitNum [lrange $test 0 5]
	set test [lrange $inter_wb 1 5]
	set test [linsert $test 0 [$w.right.bot.en1 get]]
	set inter_wb [lrange $test 0 5]
	set test [lrange $inter_wbn 1 5]
	set test [linsert $test 0 [$w.right.bot.en2 get]]
	set inter_wbn [lrange $test 0 5]
	set test [lrange $inter_Flag_Plagiotropic 1 5]
	set test [linsert $test 0 $geo1righten8]
	set inter_Flag_Plagiotropic [lrange $test 0 5]
	set test [lrange $inter_Flag 1 5]
	set test [linsert $test 0 $geo1righten9]
	set inter_Flag [lrange $test 0 5]
	set test [lrange $inter_Flag_Bending_by_node 1 5]
	set test [linsert $test 0 $geo1righten7]
	set inter_Flag_Bending_by_node [lrange $test 0 5]
	set test [lrange $inter_Theta_L 1 5]
	set test [linsert $test 0 [$w.right.bot.en3 get]]
	set inter_Theta_L [lrange $test 0 5]
	set test [lrange $inter_Theta_F 1 5]
	set test [linsert $test 0 [$w.right.bot.en4 get]]
	set inter_Theta_F [lrange $test 0 5]
	set test [lrange $inter_Theta_B 1 5]
	set test [linsert $test 0 [$w.right.bot.en5 get]]
	set inter_Theta_B [lrange $test 0 5]
	set test [lrange $inter_Flag_Organ_bending 1 5]
	set test [linsert $test 0 $geo1righten6]
