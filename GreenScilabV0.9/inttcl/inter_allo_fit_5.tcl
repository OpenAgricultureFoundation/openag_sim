...
foreach {i item} {1 "allo_I_b   " 2 "allo_I_a   " 3 "allo_Pe_b" 4 "allo_Pe_a" 5 "allo_B_b   " 6 "allo_B_a   "} {
   ...
   checkbutton $w.left.chb$i -variable allo5leftchb$i
}
foreach {i item} {1 "leaf_thick          " 2 "female_density  " 3 "male_density    " 4 "node_density     "} {
   ...
   checkbutton $w.right.chb$i -variable allo5rightchb$i
}
...
proc init_widget {} {
	...
	for {set i 1} {$i<=4} {incr i} {
	   ...
	   global allo5leftchb$i
	   global allo5rightchb$i
	}
	
	set allo5leftchb1 [lindex $inter_c_a_bI 4]
	set allo5leftchb2 [lindex $inter_c_a_aI 4]
	set allo5leftchb3 [lindex $inter_c_a_bP 4]
	set allo5leftchb4 [lindex $inter_c_a_aP 4]
	set allo5rightchb1 [lindex $inter_c_Th_B 4]
	set allo5rightchb2 [lindex $inter_c_Den_Ff 4]
	set allo5rightchb3 [lindex $inter_c_Den_Fm 4]
	set allo5rightchb4 [lindex $inter_c_Den_I 4]
...
proc allo_5_ok {} {
	...
	set test1 [lrange $inter_c_a_bI 0 3]
	set test2 [lrange $inter_c_a_bI 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 $allo5leftchb1]
	set inter_c_a_bI [lrange $test 0 5]
	set test1 [lrange $inter_c_a_aI 0 3]
	set test2 [lrange $inter_c_a_aI 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 $allo5leftchb2]
	set inter_c_a_aI [lrange $test 0 5]
	set test1 [lrange $inter_c_a_bP 0 3]
	set test2 [lrange $inter_c_a_bP 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 $allo5leftchb3]
	set inter_c_a_bP [lrange $test 0 5]
	set test1 [lrange $inter_c_a_aP 0 3]
	set test2 [lrange $inter_c_a_aP 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 $allo5leftchb4]
	set inter_c_a_aP [lrange $test 0 5]
	set test1 [lrange $inter_c_Th_B 0 3]
	set test2 [lrange $inter_c_Th_B 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 $allo5rightchb1]
	set inter_c_Th_B [lrange $test 0 5]
	set test1 [lrange $inter_c_Den_Ff 0 3]
	set test2 [lrange $inter_c_Den_Ff 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 $allo5rightchb2]
	set inter_c_Den_Ff [lrange $test 0 5]
	set test1 [lrange $inter_c_Den_Fm 0 3]
	set test2 [lrange $inter_c_Den_Fm 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 $allo5rightchb3]
	set inter_c_Den_Fm [lrange $test 0 5]
	set test1 [lrange $inter_c_Den_I 0 3]
	set test2 [lrange $inter_c_Den_I 5 5]
	set test [concat $test1 $test2]
	set test [linsert $test 4 $allo5rightchb4]
