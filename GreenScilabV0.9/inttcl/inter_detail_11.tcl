...
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_11_ok
button $dw.buttons.cancel -text "Cancel" -command detail_11_cancel
button $dw.buttons.display -text "Display" -command detail_11_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de11en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de11en11 [lindex $inter_Nu_B1 0]
	set de11en12 [lindex $inter_Ang_B1 0]
	set de11en13 [lindex $inter_VB 0]
	set de11en21 [lindex $inter_Nu_Ff1 0]
	set de11en22 [lindex $inter_Ang_Ff1 0]
	set de11en23 [lindex $inter_VF 0]
	set de11en31 [lindex $inter_Nu_Fm1 0]
	set de11en32 [lindex $inter_Ang_Fm1 0]
	set de11en41 [lindex $inter_Nu_A1 0]
	set de11en42 [lindex $inter_Ang_A1 0]
	set de11en43 [lindex $inter_VI 0]
