...
toplevel $w
wm title $w "PA 1 -- Output Parameter Setting"
wm iconname $w "Greenlab"
wm geometry $w 650x200+150+200

######### create "ok" and "cancel" buttons
frame $w.buttons 
button $w.buttons.ok -text "Ok" -command outp_1_ok
button $w.buttons.cancel -text "Cancel" -command outp_1_cancel
...
checkbutton $w.top.chb1 -variable op1chb1
checkbutton $w.top.chb2 -variable op1chb2
...
label $w.bot.left.bot.lb2 -text "Number of living organs in plant           " -width 40
...
checkbutton $w.bot.left.bot.chb1 -variable op1chb3
checkbutton $w.bot.left.bot.chb2 -variable op1chb4
checkbutton $w.bot.left.bot.chb3 -variable op1chb5
checkbutton $w.bot.left.bot.chb4 -variable op1chb6
checkbutton $w.bot.right.bot.chb1 -variable op1chb7
checkbutton $w.bot.right.bot.chb2 -variable op1chb8
checkbutton $w.bot.right.bot.chb3 -variable op1chb9
checkbutton $w.bot.right.bot.chb4 -variable op1chb10
...
proc init_widget {} {
	...
	set op1chb1 [lindex $inter_Flag_leaf 0]
	set op1chb2 [lindex $inter_Flag_fruit 0]
	set op1chb3 [lindex $inter_Flag_topo_disp 0]
	set op1chb4 [lindex $inter_Flag_topo_disp_l 0]
	set op1chb5 [lindex $inter_Flag_topo_disp_a 0]
	set op1chb6 [lindex $inter_Flag_biomass_num 0]
	set op1chb7 [lindex $inter_Flag_biomass_fig_phy 0]
	set op1chb8 [lindex $inter_Flag_size_fig_phy 0]
	set op1chb9 [lindex $inter_Flag_geo_3D 0]
	set op1chb10 [lindex $inter_Flag_geo_skeleton 0]
...
proc outp_1_ok {} {
	...
	set test [lrange $inter_Flag_leaf 1 5]
	set test [linsert $test 0 $op1chb1]
	set inter_Flag_leaf [lrange $test 0 5]
	set test [lrange $inter_Flag_fruit 1 5]
	set test [linsert $test 0 $op1chb2]
	set inter_Flag_fruit [lrange $test 0 5]
	set test [lrange $inter_Flag_topo_disp 1 5]
	set test [linsert $test 0 $op1chb3]
	set inter_Flag_topo_disp [lrange $test 0 5]
	set test [lrange $inter_Flag_topo_disp_l 1 5]
	set test [linsert $test 0 $op1chb4]
	set inter_Flag_topo_disp_l [lrange $test 0 5]
	set test [lrange $inter_Flag_topo_disp_a 1 5]
	set test [linsert $test 0 $op1chb5]
	set inter_Flag_topo_disp_a [lrange $test 0 5]
	set test [lrange $inter_Flag_biomass_num 1 5]
	set test [linsert $test 0 $op1chb6]
	set inter_Flag_biomass_num [lrange $test 0 5]
	set test [lrange $inter_Flag_biomass_fig_phy 1 5]
	set test [linsert $test 0 $op1chb7]
	set inter_Flag_biomass_fig_phy [lrange $test 0 5]
	set test [lrange $inter_Flag_size_fig_phy 1 5]
	set test [linsert $test 0 $op1chb8]
	set inter_Flag_size_fig_phy [lrange $test 0 5]
	set test [lrange $inter_Flag_geo_3D 1 5]
	set test [linsert $test 0 $op1chb9]
	set inter_Flag_geo_3D [lrange $test 0 5]
	set test [lrange $inter_Flag_geo_skeleton 1 5]
	set test [linsert $test 0 $op1chb10]
	...
	ScilabEval "Flag_topo_disp(1) =[lindex $inter_Flag_topo_disp 0];";
	ScilabEval "Flag_topo_disp_l(1) =[lindex $inter_Flag_topo_disp_l 0];";
	ScilabEval "Flag_topo_disp_a(1) =[lindex $inter_Flag_topo_disp_a 0];";
	ScilabEval "Flag_leaf(1) = [lindex $inter_Flag_leaf 0];";
	ScilabEval "Flag_fruit(1) = [lindex $inter_Flag_fruit 0];";
	ScilabEval "Flag_biomass_num(1) = [lindex $inter_Flag_biomass_num 0];";
	ScilabEval "Flag_biomass_fig_phy(1) = [lindex $inter_Flag_biomass_fig_phy 0];";
	ScilabEval "Flag_size_fig_phy(1) = [lindex $inter_Flag_size_fig_phy 0];";
	ScilabEval "Flag_geo_3D(1) = [lindex $inter_Flag_geo_3D 0];";
