...
toplevel $dw
wm title $dw "PA 2 -- metamer parameters"
wm iconname $dw "Greenlab"
wm geometry $dw 320x165+280+240

######### create "ok" and "cancel" buttons
frame $dw.buttons 
button $dw.buttons.ok -text "Ok" -command detail_24_ok
button $dw.buttons.cancel -text "Cancel" -command detail_24_cancel
button $dw.buttons.display -text "Display" -command detail_24_display
...
for {set i 1} {$i<=4} {incr i} {
   for {set j 1} {$j<=4} {incr j} {
      entry $dw.f.en$j$i -textvariable de24en$j$i -width 8
   }
}
...
proc init_widget {} {
	...
	set de24en11 [lindex $inter_Nu_B2 3]
	set de24en12 [lindex $inter_Ang_B2 3]
	set de24en21 [lindex $inter_Nu_Ff2 3]
	set de24en22 [lindex $inter_Ang_Ff2 3]
	set de24en31 [lindex $inter_Nu_Fm2 3]
	set de24en32 [lindex $inter_Ang_Fm2 3]
	set de24en41 [lindex $inter_Nu_A2 3]
	set de24en42 [lindex $inter_Ang_A2 3]
	set de24en43 [lindex $inter_VI 1]
	set de24en13 [lindex $inter_VB 1]
	set de24en23 [lindex $inter_VF 1]
...
proc detail_24_ok {} {
	...
	set test1 [lrange $inter_Nu_B2 0 2]
	set test2 [lrange $inter_Nu_B2 4 4]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en11 get]]
	set inter_Nu_B2 [lrange $test 0 4]
	set test1 [lrange $inter_Nu_Ff2 0 2]
	set test2 [lrange $inter_Nu_Ff2 4 4]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en21 get]]
	set inter_Nu_Ff2 [lrange $test 0 4]
	set test1 [lrange $inter_Nu_Fm2 0 2]
	set test2 [lrange $inter_Nu_Fm2 4 4]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en31 get]]
	set inter_Nu_Fm2 [lrange $test 0 4]
	set test1 [lrange $inter_Nu_A2 0 2]
	set test2 [lrange $inter_Nu_A2 4 4]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en41 get]]
	set inter_Nu_A2 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_B2 0 2]
	set test2 [lrange $inter_Ang_B2 4 4]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en12 get]]
	set inter_Ang_B2 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_Ff2 0 2]
	set test2 [lrange $inter_Ang_Ff2 4 4]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en22 get]]
	set inter_Ang_Ff2 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_Fm2 0 2]
	set test2 [lrange $inter_Ang_Fm2 4 4]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en32 get]]
	set inter_Ang_Fm2 [lrange $test 0 4]
	set test1 [lrange $inter_Ang_A2 0 2]
	set test2 [lrange $inter_Ang_A2 4 4]
	set test [concat $test1 $test2]
	set test [linsert $test 3 [$dw.f.en42 get]]
	set inter_Ang_A2 [lrange $test 0 4]
	set test1 [lrange $inter_VB 0 0]
	set test2 [lrange $inter_VB 2 5]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en13 get]]
	set inter_VB [lrange $test 0 5]
	set test1 [lrange $inter_VF 0 0]
	set test2 [lrange $inter_VF 2 5]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en23 get]]
	set inter_VF [lrange $test 0 5]
	set test1 [lrange $inter_VI 0 0]
	set test2 [lrange $inter_VI 2 5]
	set test [concat $test1 $test2]
	set test [linsert $test 1 [$dw.f.en43 get]]
...
proc detail_24_cancel {} {
  ...
  set Flag_fit $Flag_fit
	...
	set Nu_I11 [lindex $inter_Nu_I2 0]
	set Nu_I12 [lindex $inter_Nu_I2 1]
	set Nu_I13 [lindex $inter_Nu_I2 2]
	set Nu_I14 [lindex $inter_Nu_I2 3]
